...
밀크파트너스 주식회사는 최소한의 개인정보만을 필요한 시점에 수집하고, 수집한 개인정보는 고지한 범위 내에서만 사용합니다. 사전 동의 없이 그 범위를 초과하여 이용하거나 외부에 공개하지 않습니다. 
...
④ 법령 및 약관 위반 방지를 위한 목적
      ...
      <div class="checkbox-container">
        ...
        <button @click="proceed" :disabled="!isAgreed">확인</button>
      </div>
    </div>
  </div>
</template>
